...
export const GoogleGeminiEffect = ({
    ...
    return (
        <div className={cn("sticky top-80", className)}>
            ...
            <p className="text-xs md:text-xl font-normal text-center text-neutral-400 mt-4 mx-auto">
                {description ||
                    `Dynamic Software Engineer specializing in Java and the MERN stack, delivering innovative and efficient solutions.`}
            </p>
